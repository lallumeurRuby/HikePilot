...
- [x] 02.1 相關規格已審查 — **簽名**: 2026-09-18 16:40
- [x] 02.2 交付物已審查 — **簽名**: 2026-09-18 16:40

## LGTM 附註

- 新增 `questionnaire_question_option`、`questionnaire_question_scenario` 兩張表。
- route.terrain_* 與 Q5 情境代碼暫不對齊（無現存耦合邏輯），留待未來需要時處理。
